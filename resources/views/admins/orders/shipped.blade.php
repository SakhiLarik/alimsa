    ...
    <div class="admin-container">
        <div class="container search-container -mt-5">
            <form action="/admin/orders/search" method="post" class="grouped-btns items-center justify-center">
                @csrf
                @method('post')
                <input type="hidden" name="page" value="shipped">
                ...
                <a href="/admin/orders/shipped" class="primary-btn text-lg hidden lg:block">Reset</a>
            </form>
        </div>
        <h1 class="text-3xl my-4">
            Users with Shipped Orders
        </h1>
                            ...
                            <form action="/admin/orders/shippment_process" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card p-5 m-2 product-card">
                                    ...
                                    @foreach ($orders as $order)
                                        ...
                                        @else
                                        <div class="shadow-lg shadow-gray-300 p-5">
                                            <p class="bolder  text-lg">Track This Order</p>
                                            <p>Curior Service: <span class="text-redish">{{$order->service}}</span></p>
                                            <p>Tracking ID: <span class="text-redish">{{$order->tracking_id}}</span></p>
                                        </div>
        ...
        <div class="main-container my-5">
            @if (!$orderCounter>0)
                <h1 class="text-xl bolder text-center text-slate-500">Sorry! There is no any shipped order yet.</h1>
            @endif
        </div>
    </div>
