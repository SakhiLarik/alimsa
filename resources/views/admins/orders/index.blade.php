    ...
    <div class="admin-container">
        <div class="container search-container -mt-5">
            <form action="/admin/orders/search" method="post" class="grouped-btns items-center justify-center">
                ...
                <a href="/admin/orders/" class="primary-btn text-lg hidden lg:block">Reset</a>
            </form>
        </div>
        <h1 class="text-3xl my-4">
            All User with All Orders
        </h1>
                        ...
                        <div class="col-span-1">
                            <form action="/admin/orders/shippment_process" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card p-5 m-2 product-card">
                                    ...
                                    {{-- <div class="">
                                        <input type="hidden" name="user_id" value="{{ $user->id }}">
                                        <button type="submit" class="block primary-btn">Start Shippment Process</button>
                                    </div> --}}
                                </div>
                            </form>
                        </div>
        ...
        <div class="main-container my-5">
            @if (!$orderCounter>0)
                <h1 class="text-xl bolder text-center text-slate-500">Sorry! There is no any single order yet.</h1>
            @endif
        </div>
    </div>
