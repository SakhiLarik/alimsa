    ...
    <div class="admin-container">
        <div class="container search-container -mt-5">
            <form action="/admin/orders/search" method="post" class="grouped-btns items-center justify-center">
                ...
                <a href="/admin/orders/completed" class="primary-btn text-lg hidden lg:block">Reset</a>
            </form>
        </div>
        ...
        <div class="main-container my-5">
            @if (!$orderCounter>0)
                <h1 class="text-xl bolder text-center text-slate-500">Sorry! There is no any completed order yet.</h1>
            @endif
        </div>
    </div>
