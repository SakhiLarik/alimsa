                    ...
                    <div class="list m-5">
                        <ul class="space-y-1 bolder">
                            @if (count($subCategory) > 0)
                                <p class="text-primary bolder mb-3 px-5">Sub Categories</p>
                                <li class="px-5 py-1"><a class=" text-primary text-redish-hover hover:border-b hover:border-b-red-400" href="/product/category/{{ $category->id }}">All</a></li>
                                @foreach ($subCategory as $item)
                                    <li class="px-5 py-1"><a
                                            class="text-redish-hover text-primary hover:border-b hover:border-b-red-400"
